...
class RightBarTheme {
  ...
  RightBarTheme({
    ...
    this.activeSwitchBorderColor = const Color(0xFFE41C24),
  ...
  static final RightBarTheme lightRightBarTheme = RightBarTheme(
      ...
      activeSwitchBorderColor: Color(0xFFE41C24),
...
class ContentTheme {
  ...
  final Color primary, onPrimary, lightPrimary;
  ...
  ContentTheme({
    ...
    this.primary = const Color(0xFFE41C24),
    this.lightPrimary = const Color.fromARGB(255, 203, 164, 214),
    this.onPrimary = const Color(0xffffffff),
    this.disabled = const Color(0xffffffff),
    this.onDisabled = const Color(0xffffffff),
    this.secondary = const Color(0xFFE41C24),
    this.onSecondary = const Color(0xffffffff),
    this.success = const Color(0xFFDF2600),
