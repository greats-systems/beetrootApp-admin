...
class _VehiclesPageState extends State<VehiclesPage>
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FxBreadcrumb(
                      children: [
                        FxBreadcrumbItem(name: "transporter".tr()),
        ...
        children: [
          Row(
            ...
            children: [
              FxButton(
                onPressed: () {
                  providerController.goToCreateVehicle();
                },
                elevation: 0,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FxSpacing.width(8),
                    FxText.labelMedium(
                      'add_new_vehicle'.tr().capitalizeWords,
                      color: contentTheme.onPrimary,
                    ),
                  ],
                ),
              ...
              FxButton(
                onPressed: () {
                  providerController.goToAllocateVehicle();
                },
                elevation: 0,
                padding: FxSpacing.xy(20, 16),
                backgroundColor: contentTheme.primary,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FxSpacing.width(8),
                    FxText.labelMedium(
                      'allocate_vehicle'.tr().capitalizeWords,
                      color: contentTheme.onPrimary,
                    ),
                  ],
                ),
          ...
          Wrap(
            children: [
              FxButton(
                ...
                borderRadiusAll: 20,
                child: FxText.bodySmall('Trucks', color: contentTheme.light),
              ),
              FxSpacing.width(8),
              FxButton(
                onPressed: () {
  ...
  Widget buildHotJobs() {
    return Obx(() => Column(
          ...
          children: [
            FxText.titleMedium(
              "All Vehicles (${providerController.accountVehicles.length})",
              fontWeight: 600,
            ),
            FxSpacing.height(16),
            SizedBox(
