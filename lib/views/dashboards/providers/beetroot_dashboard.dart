...
class BeetrootDashboard extends StatefulWidget {
  const BeetrootDashboard({super.key});

  @override
  BeetrootDashboardState createState() => BeetrootDashboardState();
}

class BeetrootDashboardState extends State<BeetrootDashboard>
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "order_web_visits".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "exhibits_published".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "business_profiles".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        FxText.titleMedium(
                          "bookings_confirmes".tr().capitalizeWords,
                          fontWeight: 600,
                        ),
                        FxButton.text(
                        ...
                        child: DataTable(
                            ...
                            rows: controller.products
                                .mapIndexed((index, data) => DataRow(cells: [
                                      ...
                                      DataCell(
                                          FxText.bodyMedium('\$${data.price}')),

                                      DataCell(
                                          FxText.bodyMedium('${data.stock}')),
                        ...
                        child: DataTable(
                          ...
                          rows: controller.customers
                              .mapIndexed(
                                (index, data) => DataRow(
                                  cells: [
                                    DataCell(FxText.bodyMedium("#${data.id}")),
                                    DataCell(
                                      SizedBox(
                                        width: 180,
                                        child: Row(
                                    ...
                                    DataCell(FxText.bodyMedium(
                                        '${data.phoneNumber}')),
                                    DataCell(
                                        FxText.bodyMedium('\$${data.balance}')),
                                    DataCell(FxText.bodyMedium(
                                        '${data.ordersCount}')),
                                    DataCell(Align(
                                      alignment: Alignment.center,
