...
class TransporterDashboard extends StatefulWidget {
  ...
  @override
  TransporterDashboardState createState() => TransporterDashboardState();
}

class TransporterDashboardState extends State<TransporterDashboard>
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "total_orders".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "order_requests".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "commodities_in_transit".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        FxSpacing.height(4),
                        FxText.bodySmall(
                          "commodities_delivered".tr().capitalizeWords,
                          muted: true,
                          fontWeight: 600,
                        ),
                      ],
