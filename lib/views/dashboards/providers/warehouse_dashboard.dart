...
class WarehouseDashboardState extends State<WarehouseDashboard>
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            FxSpacing.height(4),
                            FxText.bodySmall(
                              "total_sales".tr().capitalizeWords,
                              muted: true,
                              fontWeight: 600,
                            ),
                          ],
                          ...
                          Column(
                            ...
                            children: [
                              Obx(() => FxText.headlineSmall(
                                    "${ordersController.totalOrderRequests}",
                                    fontWeight: 600,
                                  )),
                              FxSpacing.height(4),
                              FxText.bodySmall(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            FxSpacing.height(4),
                            FxText.bodySmall(
                              "commodities_on_delivery".tr().capitalizeWords,
                              muted: true,
                              fontWeight: 600,
                            ),
                          ],
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            FxText.headlineSmall(
                              "${ordersController.totalIssuedWHReciepts}",
                              fontWeight: 600,
                            ),
                            FxSpacing.height(4),
                            FxText.bodySmall(
                              "issued_reciepts".tr().capitalizeWords,
                              muted: true,
                              fontWeight: 600,
                            ),
                          ],
              ...
              FxFlexItem(
                ...
                child: FxCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        FxText.titleMedium(
                          "top_3_commodity_market_demand".tr().capitalizeWords,
                          fontWeight: 600,
                        ),
                        FxSpacing.height(36),
                        Row(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            FxText.titleMedium(
                              "commodity_market".tr().capitalizeWords,
                              fontWeight: 600,
                            ),
                            FxButton.text(
