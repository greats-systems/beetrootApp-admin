...
class BeetrootLeftBar extends StatefulWidget {
  final bool isCondensed;
  const BeetrootLeftBar({Key? key, this.isCondensed = false}) : super(key: key);

  @override
  _BeetrootLeftBarState createState() => _BeetrootLeftBarState();
}

class _BeetrootLeftBarState extends State<BeetrootLeftBar>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        labelWidget("App Analytics".capitalizeWords),
        Obx(
          () => NavigationItem(
