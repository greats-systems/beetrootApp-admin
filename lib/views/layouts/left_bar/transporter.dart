...
class TransporterLeftBar extends StatefulWidget {
  final bool isCondensed;
  const TransporterLeftBar({Key? key, this.isCondensed = false})
      : super(key: key);

  @override
  _TransporterLeftBarState createState() => _TransporterLeftBarState();
}

class _TransporterLeftBarState extends State<TransporterLeftBar>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        labelWidget("sales".capitalizeWords),
        Obx(
          () => NavigationItem(
            iconData: Icons.storefront_outlined,
            title: "orders - ${ordersController.totalOrders}".capitalizeWords,
            route: '/orders',
            isCondensed: isCondensed,
          ),
        ),
        ...
        NavigationItem(
          ...
          title: "sales".capitalizeWords,
          route: '/apps/ecommerce/customers',
          isCondensed: isCondensed,
        ),
        // FxSpacing.height(32),
        labelWidget("Vehicles".capitalizeWords),
        NavigationItem(
          iconData: Icons.local_shipping,
          title: "Vehicles Analytics".capitalizeWords,
          route: '/vehicles',
          isCondensed: isCondensed,
        ),
        NavigationItem(
          iconData: Icons.add_road_sharp,
          title: "add_vehicle".capitalizeWords,
          route: '/add_vehicle',
          isCondensed: isCondensed,
        ),
        ...
        NavigationItem(
          ...
          title: "HR_analytics".capitalizeWords,
          route: '/hr_analytics',
          isCondensed: isCondensed,
        ),
        NavigationItem(
