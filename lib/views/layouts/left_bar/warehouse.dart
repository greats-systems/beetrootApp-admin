...
class WarehouseLeftBar extends StatefulWidget {
  final bool isCondensed;
  const WarehouseLeftBar({Key? key, this.isCondensed = false})
      : super(key: key);

  @override
  _WarehouseLeftBarState createState() => _WarehouseLeftBarState();
}

class _WarehouseLeftBarState extends State<WarehouseLeftBar>
    ...
    return Obx(() => Column(
          ...
          children: [
            ...
            NavigationItem(
              ...
              title: "orders - ${ordersController.totalOrderRequests}".tr(),
              route: '/orders',
              isCondensed: isCondensed,
            ),
            NavigationItem(
              iconData: Icons.attach_money_outlined,
              title: "farmers - ${authController.serviceProviders.length}".tr(),
              route: '/apps/ecommerce/customers',
              isCondensed: isCondensed,
            ),
            NavigationItem(
              iconData: Icons.attach_money_outlined,
              title: "buyers - ${authController.serviceProviders.length}".tr(),
              route: '/apps/ecommerce/customers',
              isCondensed: isCondensed,
            ),
            // FxSpacing.height(32),
            ...
            NavigationItem(
              iconData: Icons.storefront_outlined,
              title: "WH_reciepts (${ordersController.totalIssuedWHReciepts})"
                  .tr(),
