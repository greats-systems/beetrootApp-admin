...
class NoAccountLeftBar extends StatefulWidget {
  final bool isCondensed;
  const NoAccountLeftBar({Key? key, this.isCondensed = false})
      : super(key: key);

  @override
  _NoAccountLeftBarState createState() => _NoAccountLeftBarState();
}

class _NoAccountLeftBarState extends State<NoAccountLeftBar>
